...
export const downloadAttendanceReport = {
  pdf: () => downloadReport("AttendanceReport", "pdf"),
  excel: () => downloadReport("AttendanceReport", "excelopenxml"),
  csv: () => downloadReport("AttendanceReport", "csv"),
  word: () => downloadReport("AttendanceReport", "wordopenxml"),
};
